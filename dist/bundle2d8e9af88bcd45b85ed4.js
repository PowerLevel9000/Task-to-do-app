...
const htmlGenerator = () => {
  ...
  dataBase.forEach((element) => {
    if (element.check) {
      //  I should use input instead of contenteditable so that i can have all js event for input such as onfocus
      tasks.innerHTML += `
...
clearBtn.addEventListener('click', _status_js__WEBPACK_IMPORTED_MODULE_1__.clear);
...
const clear = () => {
    const filteredBase = ___WEBPACK_IMPORTED_MODULE_0__.dataBase.filter((c) => c.check === false);
...
/******/ })()
;
//# sourceMappingURL=bundle2d8e9af88bcd45b85ed4.js.map