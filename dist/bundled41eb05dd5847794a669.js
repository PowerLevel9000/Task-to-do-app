...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ BookCollection)
/* harmony export */ });
...
class BookCollection {
  ...
  load() {
    ...
    this.collection = JSON.parse(bookCollection).map(
      (book) => new _Book_js__WEBPACK_IMPORTED_MODULE_0__["default"](book.title, book.author, book.id),
    );
  }

  add(title, author) {
    const newBook = new _Book_js__WEBPACK_IMPORTED_MODULE_0__["default"](title, author, Date.now());
    const newCollection = [...this.collection, newBook];
    (0,_localStorage_js__WEBPACK_IMPORTED_MODULE_1__.saveData)('bookCollection', newCollection);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "clearBooks": () => (/* binding */ clearBooks),
/* harmony export */   "clearLocalStorage": () => (/* reexport safe */ _localStorage_js__WEBPACK_IMPORTED_MODULE_0__.clearLocalStorage),
...
const clearBooks = () => {
  localStorage.clear();
  (0,_localStorage_js__WEBPACK_IMPORTED_MODULE_0__.clearLocalStorage)();
...
/* harmony import */ var _modules_BookCollection_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/BookCollection.js */ "./src/modules/BookCollection.js");
...
const bookCollection = new _modules_BookCollection_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
(0,_modules_display_js__WEBPACK_IMPORTED_MODULE_3__["default"])(bookCollection);
...
refreshButton.addEventListener('click', () => {
  (0,_modules_refresh_js__WEBPACK_IMPORTED_MODULE_1__.clearLocalStorage)();
  (0,_modules_display_js__WEBPACK_IMPORTED_MODULE_3__["default"])(bookCollection);
});
...
/******/ })()
;
//# sourceMappingURL=bundled41eb05dd5847794a669.js.map